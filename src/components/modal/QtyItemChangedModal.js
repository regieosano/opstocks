...
import '../../styles/scss/QtyItemChangedModal.scss'

class QtyItemChangedModal extends Component {
    ...
    render() {   
        return (
            <div className="modal fade"
                 ...
                 data-keyboard="false"
                 id="qtyItemChangedModal"
            >
             <div className="modal-dialog">
                <div className="modal-content modalBackdropForItemChanged">
                  ...
                  <div className="modal-footer">    
                     ...
                     <button type="button"
                             ...
                             data-dismiss="modal"
                             onClick={() => this.refs.updatedQtyRequested.value = ''}
                     >
                         Cancel
                     </button>
                 </div>
...
QtyItemChangedModal.propTypes = {
    handleUpdatedItem: PropTypes.func.isRequired,
